<template>
    <div class="inputQuestion" v-loading="isLoading" element-loading-text="添加题目中...">
...
<style>
    ...
    .inputQuestion .questionStem #question-stem {
        width: 1000px;
        height: 150px;
        border-radius: 5px;
        position: relative;
    ...
    .inputQuestion .knowledge #question-knowledge {
        width: 1000px;
        height: 125px;
        border-radius: 5px;
    }
