    ...
    <div class="userNav">
      ...
      <div class="user-container" @mouseover="showDropdown" @mouseleave="hideDropdown">
        <span class="user-info">
          <img :src="'data:image/png;base64,' + avatarImgBase64" alt="User Avatar">
          {{ userName }}
        </span>
        <ul class="dropdown" v-show="isDropdownVisible">
          <li ><router-link :to="{name:'studentMessage', query: {userId: this.userId}}"><span class="Jump">账号管理</span></router-link></li>
